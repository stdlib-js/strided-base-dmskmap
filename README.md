...
```javascript
dmskmap = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dmskmap@umd/bundle.js' )
```

To include the bundle in a webpage,

```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/strided-base-dmskmap@umd/bundle.js"></script>
```
...
<script type="text/javascript" src="https://cdn.jsdelivr.net/gh/stdlib-js/random-base-bernoulli@umd/bundle.js"></script>
